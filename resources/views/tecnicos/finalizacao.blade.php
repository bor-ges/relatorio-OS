        ...
        <div class="grid grid-cols-4 grid-rows-6 gap-4">
            <div class="col-span-2">
                <div>
                    ...
                    <input type="text" id="small-input" value="{{$tecnico->numero_os}}" class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
            </div>
            ...
            <div class="col-start-4">
                ...
                <select id="tec_resp" class="block w-full p-2 mb-6 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    <option value="{{$tecnico->tipo_os}}">Técnico 1</option>
                    <option value="{{$tecnico->tipo_os}}">Técnico 2</option>
                </select>
            </div>
            ...
            <div class="col-start-4 row-start-2">
                ...
                <div class="grid grid-cols-2" id="divzinha">
                    <div>
                        <input type="text" value="{{$tecnico->inicio}}" id="small-input" placeholder="Início" class="block p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    <div class="col-start-5">
                        <input type="text" value="{{$tecnico->fim}}" id="small-input" placeholder="Fim" class="block p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                </div>
            </div>
            <div>
                <div class="flex items-center ">
                    <input id="vue-checkbox" type="checkbox" value="{{$tecnico->servico_exec}}" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
            ...
            <div class="row-start-3">
                <div class="flex items-center ">
                    <input id="vue-checkbox" type="checkbox" value="{{$tecnico->sem_danos}}" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
            ...
            <div class="row-start-3">
                <div class="flex items-center ">
                    <input id="vue-checkbox" type="checkbox" value="{{$tecnico->funcionamento}}" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
            ...
            <div class="row-start-3">
                <div class="flex items-center">
                    <input id="vue-checkbox" type="checkbox" value="{{$tecnico->com_danos}}" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
            ...
            <div >
                <div class="flex items-center">
                    <input id="vue-checkbox" type="checkbox" value="{{$tecnico->servico_cobrado}}" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
            ...
            <div class="row-start-4">
                <div class="flex items-center">
                    <input id="vue-checkbox" type="checkbox" value="{{$tecnico->insento_cobranca}}" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
            ...
            <div class="col-start-4 row-start-4">
                <div>
                    ...
                    <input type="text" id="cli_endereco" value="{{$tecnico->com_danos}}" class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
            </div>
